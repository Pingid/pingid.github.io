...
/***/ function(module, exports, __webpack_require__) {
	...
	var _Projects = __webpack_require__(178);
	...
	var Page = (function (_Component) {
	  ...
	  function Page(props) {
	    ...
	    _this.state = {
	      ...
	      frontText: _this.props.content.front.frontText,
	      navActive: ''
	    };
	    function rem() {
	      this.state = {
	  ...
	  _createClass(Page, [{
	    key: '_handleNavClick',
	    value: function _handleNavClick(name) {
	      this.setState({
	        navStyle: { top: 0 },
	        navActive: name
	      });
	    ...
	    value: function render() {
	      ...
	      var navActive = this.state.navActive;

	      var text = this.state.frontText;
	      var showing = function showing() {
	        ...
	        return _react2.default.createElement(
	          _reactMotion.Motion,
	          { defaultStyle: { x: 0 }, style: { x: (0, _reactMotion.spring)(1000, [100, 25]) } },
	          function (val) {
	            return _react2.default.createElement(
	              'div',
	              { className: 'content-wrapper', style: { opacity: val.x / 1000 } },
	              current()
	            );
	          }
	        );
	      ...
	      return _react2.default.createElement(
	        ...
	        _react2.default.createElement(
	          _reactMotion.Motion,
	          { style: { x: (0, _reactMotion.spring)(this.state.navStyle.top, [180, 25]) } },
	          function (val) {
	            return _react2.default.createElement(_Nav2.default, {
	              text: stringReduce(_this2.state.frontText, (val.x - (window.innerHeight / 2 - 90)) * -0.13),
	              navActive: _this2.state.navActive,
	              style: { top: val.x },
	              handleNav: function handleNav(name) {
	                return _this2._handleNavClick(name);
	              } });
	          }
	        ),
	        showing()
	...
	(0, _reactDom.render)(_react2.default.createElement(Page, { content: _pageContent2.default }), document.getElementById('main'));
...
/***/ function(module, exports) {
	...
	exports.default = {
	  front: {
	    frontText: ["Hello I am", ", feel free to check out some of the", "I have been involved with and the", "I make in my free time."]
	  },
	  content: {
	    projects: [{
	      title: "citri",
	    ...
	    about: {
	      p1: "I grew up in a small town in south east England where I quickly learned that the internet was a wonderful window into the outside world. I studied fine art then design at school and it was a small step to channel those skills into the digital realm.",
	      p2: "It has always been of utmost importance to understand the tools that I use which has lead me for the past two years into software and front-end development. In this time I have developed a solid grasp of javascript and some of the libraries and frameworks.",
	      p3: "When it comes to design I place great value in form following function and try to live by Steve Job’s statement 'Never let a passion for the perfect take precedence over pragmatism'."
	    }
	  },
	  footer: {
	...
	var Nav = (function (_Component) {
	  ...
	  _createClass(Nav, [{
	    ...
	    value: function render() {
	      ...
	      var navActive = _props.navActive;
	      var handleNav = _props.handleNav;
	      var style = _props.style;

	      var buttonStyle = function buttonStyle(value) {
	        if (navActive === "") {
	      ...
	      return _react2.default.createElement(
	        'div',
	        { className: 'nav-wrapper', style: style },
	        _react2.default.createElement(
	          'h1',
	          null,
	          _react2.default.createElement(
...
/***/ function(module, exports, __webpack_require__) {
	...
	var Doodles = (function (_Component) {
	  ...
	  function Doodles() {
	    ...
	    return _possibleConstructorReturn(this, Object.getPrototypeOf(Doodles).apply(this, arguments));
	  }
	    ...
	    value: function render() {
	      return _react2.default.createElement(
	        ...
	        _react2.default.createElement(
	          'div',
	          { className: 'container' },
	          _react2.default.createElement(_Doodle2.default, { style: { width: "18rem", height: "13rem" } }),
	          _react2.default.createElement(_Doodle2.default, { style: { width: "19rem", height: "11rem" } }),
	          _react2.default.createElement(_Doodle2.default, { style: { width: "17rem", height: "10rem" } }),
	          _react2.default.createElement(_Doodle2.default, { style: { width: "15rem", height: "13rem" } }),
	          _react2.default.createElement(_Doodle2.default, { style: { width: "09rem", height: "19rem" } }),
	          _react2.default.createElement(_Doodle2.default, { style: { width: "10rem", height: "15rem" } })
	        )
	      );
	    }
	  }]);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var Doodle = (function (_Component) {
	  _inherits(Doodle, _Component);

	  function Doodle() {
	    _classCallCheck(this, Doodle);

	    return _possibleConstructorReturn(this, Object.getPrototypeOf(Doodle).apply(this, arguments));
	  }

	  _createClass(Doodle, [{
	    key: "render",
	    value: function render() {
	      return _react2.default.createElement("div", { className: "doodle", style: this.props.style });
	    }
	  }]);
