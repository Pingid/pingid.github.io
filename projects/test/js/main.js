...
/***/ function(module, exports, __webpack_require__) {
	...
	var _reactImageloader = __webpack_require__(161);
	...
	var LazyImage = function (_Component) {
	  ...
	  function LazyImage() {
	    ...
	    return _possibleConstructorReturn(this, Object.getPrototypeOf(LazyImage).apply(this, arguments));
	  }
	  ...
	  _createClass(LazyImage, [{
	    ...
	    // }
	    // componentDidMount() {
	    //   const imgTag = findDOMNode(this.refs.img);
	    ...
	    // }
	    value: function render() {
	      // const className = this.props.className ? this.props.className : 'image'
	      // const classes = () => {
	      //   if(this.state.loaded) return className + ' image-loaded'
	      //   return className + 'image-loading'
	      // }
	      return _react2.default.createElement(
	        'div',
	        { className: 'image-wrapper' },
	        _react2.default.createElement(_reactImageloader2.default, { src: this.props.src })
	      );
	    }
	  }]);
