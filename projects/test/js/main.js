	  ...
	  var buildArray = function buildArray(num, ext, root) {
	    var iter = function iter(acc, arr) {
	      ...
	      return iter(acc + 1, [].concat(arr, [{
	        small: root + acc + '.' + ext,
	        large: root + 'large/' + acc + '.' + ext
	      }]));
	    };
	    return iter(1, []);
	  };
	  return {
	    fashion: buildArray(18, 'jpg', 'img/fashion/'),
	    portrait: buildArray(17, 'jpg', 'img/portrait/'),
	    travel: buildArray(23, 'jpg', 'img/travel/')
	  };
	};
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _LazyImage = __webpack_require__(161);
	...
	exports.default = function (_ref) {
	  ...
	  return _react2.default.createElement(
	    ...
	    srcArray.map(function (img, index) {
